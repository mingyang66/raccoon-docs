...
- logger日志
  ...
  - [4. 基于logback-springboot集成日志系统集成](base/logback/基于logback-springboot集成日志系统集成)
  - [5. 基于logback-mybatis记录数据库sql记录](base/logback/基于logback-mybatis记录数据库sql记录)
...
- 数据库
  ...
  - [1.4. druid连接池-泄漏removeAbandonedconnectedTimeNano属性配置](datasource/druid/druid数据库连接池泄漏removeAbandonedconnectedTimeNano属性配置)
  - [1.5. druid连接池-driverClassName驱动类为何可以不用配置](datasource/druid/druid数据库连接池driverClassName驱动类为何可以不用配置)
  - [1.6. druid连接池-initial-size参数详解](datasource/druid/druid数据库连接池initial-size参数详解)
  - [1.7. druid连接池-配置密码加密秘钥生成及配置修改](datasource/druid/druid数据库配置密码加密秘钥生成及配置修改)
  - [1.8. druid连接池-数据源检测数据库连接有效性testOnBorrow、testOnReturn、testWhileIdle属性原理分析](datasource/druid/druid数据库检测数据库连接有效性testOnBorrow、testOnReturn、testWhileIdle属性原理分析)
  - [1.9. durid连接池-mybatis注解模式动态切换多数据源](datasource/druid/dynamicdatasource)
  - [1.10. druid数据库1.2.12版本发布，新增连接池默认配置connectTimeout和socketTimeout详解](datasource/druid/druid数据库1.2.12版本发布，新增连接池默认配置connectTimeout和socketTimeout详解)
  - [1.11. druid数据库1.2.13版本发布，修复连接池默认指定connectTimeout和socketTimeout导致的问题](datasource/druid/druid数据库1.2.13版本发布，修复连接池默认指定connectTimeout和socketTimeout导致的问题)  
  - [2.1. mysql-Java查询Mysql数据库Decimal类型小数位自动截取](datasource/Java查询Mysql数据库Decimal类型小数位自动截取)
  - [3.1. springboot-AbstractRoutingDataSource抽象类实现动态多数据源切换原理解析](datasource/springboot之AbstractRoutingDataSource抽象类实现动态多数据源切换原理解析)
  - [3.2. springboot-开启事务@Transactional](datasource/springboot如何开启事务@Transactional)
  - [4.1. Mybatis-typehandlers-jsr310对Java日期对象和JDBC日期对象转换器过期](datasource/mybatis-typehandlers-jsr310对Java日期对象和JDBC日期对象转换器过期)
  - [4.2. Mybatis-批处理](datasource/Mybatis批处理学习笔记一)
  - [5.1. HikariCP-获取连接超时时间connectionTimeout配置](datasource/HikariCp/HikariCP-获取连接超时时间connectionTimeout配置)
  - [5.2. HikariCP-获取连接超时时间loginTimeout配置](datasource/HikariCp/HikariCP-获取连接超时时间loginTimeout配置)
